...
extension Color {
    ...
    static let tabBarBackground = LinearGradient(gradient: Gradient(colors: [Color("Tab Bar Background 1"), Color("Tab Bar Background 2")]), startPoint: .top, endPoint: .bottom)
